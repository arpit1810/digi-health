...
<?php include('masterSidebarLogin.php');?>
       <div id="content">
        <h1>New Doctor Request Form</h1>
        <form id="aa" action="dctet.php"  method="POST" >
            ...
            Field : <select name="fd" class="hh">
                     <option value="general">General Physician</option>
                     <option value="cardio">Cardiologist</option>
                    </select>     <br><br>
            Validity Days : <input type="text" name="da" class="hh" ><br><br>  
       ...
       <script>
        ...
        document.getElementById("cc").innerHTML = "valid user id";   
                 ...
                 xhttp.open("POST","chkiddoc.php",true);
